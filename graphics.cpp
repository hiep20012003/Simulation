...
// Đặt lại input mode cho cửa sổ console
void setConsoleMode()
{
	StdIn = GetStdHandle(STD_INPUT_HANDLE);
	DWORD mode;
...
// Vẽ text lên console với font, color tùy chỉnh
...
// Hàm xóa một vùng theo hình chữ nhật
...
// Overload hàm outtextxy tham số là string
